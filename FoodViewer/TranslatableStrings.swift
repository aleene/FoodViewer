...
//
    ...
    static let ForestFootprintPercentInProduct = NSLocalizedString("% in product.", comment: "Percent of ingredient in product")
    static let ForestFootprintProcessingFactor = NSLocalizedString("Processing factor\n(% of food after processing)", comment: "Percent of ingredient in product")
