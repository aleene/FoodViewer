...
class OpenFoodFactsRequest {
  ...
  */
    ...
    private func decode(_ jsonObject: JSON) -> FoodProduct {
        ...
        nutritionDecode(key: jsonKeys.EnergyKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.FatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MonounsaturatedFatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.PolyunsaturatedFatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SaturatedFatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.Omega3FatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.Omega6FatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.Omega9FatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.TransFatKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CholesterolKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CarbohydratesKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SugarsKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SucroseKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.GlucoseKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.FructoseKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.LactoseKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MaltoseKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.PolyolsKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MaltodextrinsKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.FiberKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ProteinsKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SodiumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SaltKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.AlcoholKey, jsonObject: jsonObject, product: product)
        
        nutritionDecode(key: jsonKeys.BiotinKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CaseinKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SerumProteinsKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.NucleotidesKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.StarchKey, jsonObject: jsonObject, product: product)
        
        nutritionDecode(key: jsonKeys.VitaminAKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminB1Key, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminB2Key, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminPPKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminB6Key, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminB9Key, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminB12Key, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminCKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminDKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminEKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VitaminKKey, jsonObject: jsonObject, product: product)
        
        nutritionDecode(key: jsonKeys.CalciumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ChlorideKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ChromiumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CopperKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.BicarbonateKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.FluorideKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.IodineKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.IronKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MagnesiumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ManganeseKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MolybdenumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.PhosphorusKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.PotassiumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SeleniumKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.SilicaKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ZincKey, jsonObject: jsonObject, product: product)
        
        nutritionDecode(key: jsonKeys.AlphaLinolenicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ArachidicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ArachidonicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.BehenicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ButyricAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CapricAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CaproicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CaprylicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.CeroticAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.DihomoGammaLinolenicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.DocosahexaenoicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.EicosapentaenoicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ElaidicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.ErucicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.GammaLinolenicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.GondoicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.LauricAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.LignocericAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.LinoleicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MeadAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MelissicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MontanicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.MyristicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.NervonicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.PalmiticAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.PantothenicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.StearicAcidKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.VoleicAcidKey, jsonObject: jsonObject, product: product)
        
        nutritionDecode(key: jsonKeys.CaffeineKey, jsonObject: jsonObject, product: product)
        nutritionDecode(key: jsonKeys.TaurineKey, jsonObject: jsonObject, product: product)
        
        nutritionDecode(key: jsonKeys.PhKey, jsonObject: jsonObject, product:product)
        nutritionDecode(key: jsonKeys.CacaoKey, jsonObject: jsonObject, product:product)
    ...
    private func nutritionDecode(key: String, jsonObject: JSON, product: FoodProduct) {
